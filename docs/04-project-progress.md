...
> 文档状态：执行版 v0.1  
> 初始日期：2026-07-30  
> 当前阶段：P8-T05 部署与回滚已完成；下一任务为 P8-T06 监控与告警
> 关联文档：  
...
| P8 | 系统验证、部署与实盘准备 | 10 | 5 | P8-T05 已完成 |
| **合计** |  | **75** | **70** | **P8 进行中** |
...
- 开始 **P8-T06：建立监控与告警**，先完成指标模型、告警分级和敏感信息脱敏；
- 接入数据完成度、服务成功率与延迟、风控拒绝、订单核对及 Kill Switch 指标；
- 完成 P0～P3 告警路由和测试送达验收后，再开始 P8-T07；
