...
> 文档状态：执行版 v0.1  
> 初始日期：2026-07-30  
> 当前阶段：P8-T07 影子运行控制面开发完成待运行；真实交易日证据尚未开始累计
> 关联文档：  
...
| P8 | 系统验证、部署与实盘准备 | 10 | 6 | P8-T06 已完成 |
| **合计** |  | **75** | **71** | **P8 进行中** |
...
- 为 **P8-T07：执行影子运行** 安全注入真实市场数据凭证，冻结提供商交易日历，并在真实市场数据和虚拟账户上连续运行至少 20 个交易日；
- 每个交易日记录数据完成度、候选稳定性、任务成功率、告警、人工干预和账实核对；
- 20 个交易日证据完整且严重问题已关闭后，才可将 P8-T07 标记为 `已完成`；
